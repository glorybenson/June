...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-non-resident-package/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                <div class="site-nav__menu-col-one">                                          
                                                    ...
                                                    <!-- <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Non resident Package</a>
                                                    </li> -->
                                                </div>
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						...
						<p>
							The Non-Resident Package is designed specifically for non-UK resident businesses and individuals who are keen on registering a UK Company. You do not have to live in the UK to be a director or shareholder of a UK company. The two requirements for incorporation purposes are having at least one shareholder and director [Both roles can subsist in the same person] and having a registered address where official documents from Government bodies such as Companies House and HMRC can be received.
						</p>

						<p>
							A major concern for overseas residents is the ability to open a UK based Business Account which could be very difficult based on the Money Laundering Regulations which Banks have to adhere to.
						</p>

						<p>
							We have set up a business relationship with Wise [Transfer Wise as previously known] to offer a standard business account for all your company transactions.
						</p>
						...
						<p>
							If you are resident overseas or your business is resident abroad and you wish to establish a branch or a presence in the UK. You may either set up a branch of your company and register the same as a branch, establish a permanent establishment or incorporate a UK company. To form a UK Company you would need:<br>
							Shareholder and a Director [both roles can reside in same person]<br>
							A UK Registered Office Address
						</p>

						<p>
							After the company is formed you would need to open a business bank account for corporate financial transactions.
						</p>

						<p>
							We have designed a package that would help meet all these requirements and more&hellip;
						</p>
						...
						<p>
							Our Apostilled document service could come in handy if you choose to open a bank account in your country of residence instead of in the newly formed company residence which is the UK. Your local bank would require the UK formation documents to be &lsquo;Apostilled&rsquo; or &lsquo;legalised&rsquo;. This service is available as an add on through our checkout process.
						</p>
						...
						<p>
							With &lsquo;The Non Residence Package&rsquo; you receive a registered office address [Annual Cost &pound;38.89 Plus VAT] and a service address for 1 Person [Annual cost &pound;25.89 Plus VAT] for the   at no additional cost, a Business Service Address [Annual Cost &pound;99.89 Plus VAT] and VAT Registration [&pound;59.89 Plus VAT]
						</p>

						<p>
							The total actual cost for this package is &pound;290.45 Plus VAT you however only have to pay &pound;134.89 Plus VAT to access this service.
						</p>
					...
					<div class="faq">
						...
						<h3>
							Are there any other hidden cost incurred under &lsquo;The Non-Resident Package&rsquo;?
						</h3>

						<p>
							The Non-Resident Formation Package has no hidden costs. The cost of &lsquo;The Non-Resident Formation Package&rsquo; is as stated. We charge &pound;134.89 Plus VAT for the package which includes the Companies House incorporation charge of &pound;12. There are however renewal charges as stated elsewhere.
						</p>

						<h3>
							Overseas Postage: How soon can I receive the Print and Bound Documents?
						</h3>

						<p>
							We aim to post out the Print and Bound Formation Documents within 7 Working days after incorporation. There would a 16% handling charge in addition to the standard Royal Mail or international mail postage cost.
						</p>
				...
				<section class="widget widget_categories">
					...
					<div class="service-list-pro">
						<ul>
							...
							<li>
								&nbsp; &nbsp; 1 X Service Address Liverpool for 12 Months
							</li>
							<li>
								&nbsp; &nbsp; 1 X Business Address Service at Liverpool for 12 Months
							</li>
							<li>
							...
							<li>
								&nbsp; &nbsp; Wise UK Business Banking at an additional cost of &pound;16
							</li>
							<li>
						...
						<div class="others-option" style="text-align: center;">
							<a class="default-btn" href="/buy/non-resident-package/">
								Order Now 
							</a>
						</div>
					</div>
...
<!-- note API: https://developer.company-information.service.gov.uk/how-to-create-an-application -->