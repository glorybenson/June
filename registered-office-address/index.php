...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-registered-office-address/">
        ...
        <div id="wrapper">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                <div class="site-nav__menu-col-one">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Registered Office Address</a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
            ...
            <!-- End Header -->
<!-- Hero Section -->
<section class="hero ptb-100" style="background-image:url(../assets/custom/images/53.png);">
	<!-- Container -->
	<div class="container">
		<!-- Row -->
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<p>
							Registered Office Address is a Companies House requirement in the process of incorporating a company. A Registered Address is the correspondence address to which all official correspondence from government agencies such as Companies House, HMRC, Government Gateway, The Pensions Regulator, Office of National Statistics amongst others is sent.
						</p>

						<p>
							Most directors tend to choose their residential address for this purpose however few who prefer to create a better corporate image or wish to protect the privacy of their residential address would opt for the Registered Office Address service we provide.
						</p>

						<p>
							The service we provide ensures that for &pound;55.00 plus VAT you can access our address at:<br>
							<br>Newspring House<br>
							3 Worcester Avenue<br>
							Old Swan<br>
							Liverpool<br>
							L13 9AZ
						</p>
						...
						<p>
							for 12 months, renewable yearly.
						</p>

						<p>
							A Registered Office address is required for any company to be incorporated. You are also required to display the registered address on all company stationery and websites.
						</p>

						<p>
							There is no further charge to scan and email official correspondence to you wherever you may be in the world within 2 working days.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<p>
							A major Companies House requirement in the incorporation process is the Registered Office Address which is the statutory address for the newly incorporated company by shares or guarantee or LLP. The statutory address must be a physical address as Companies House would not accept a Post Office Box Number. The address would remain on the Companies House public register until changed by the Directors or removed once the company is dissolved.
						</p>

						<p>
							Official correspondence from Government agencies such as Companies House, HMRC, Government Gateway, Department of Work and Pensions [DWP] amongst others would be sent to the company&rsquo;s registered address which must be within the UK jurisdiction of England, Wales, Scotland, or Northern Ireland. It is instructive to note that you can change your registered office address as and when you choose.
						</p>
						...
						<h3>
							Are there any other hidden costs incurred under the Registered Address Service?
						</h3>

						<p>
							Prime Formations offer the &lsquo;Registered Address Service&rsquo; with no hidden costs. The cost of the service is as stated. We charge &pound;55.00 plus VAT for the service. You must however be aware that our Registered Office service is strictly for that purpose only. Should you require further address services such as Service Address for Directors, Shareholders or other Company officers or Business Mail Address this must be paid for separately.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
