...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-change-accounting-reference-date/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Change of Accounting Reference Date  </a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
...
<section class="hero ptb-100" style="background-image:url(../assets/custom/images/55.png);">
	...
	<div class="container">
		...
		<div class="row pd-top-50 pd-bot-20">
			...
			<div class="col-12">
				<h1>
					Change Of Accounting Reference Date Service
				</h1>
			</div>
			<!-- End Col -->
		</div>
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<p>
							Every company registered with Companies House and listed on the public register must prepare accounts that report on the performance and activities of the company during the financial year. For new companies, the financial year starts on the day of incorporation however for companies in their second year and following, the financial year starts on the day after the previous financial year ended. Financial years must be determined by alluding to an accounting reference period.
						</p>

						<p>
							The financial year ends on the Accounting Reference Date [ARD]. For new companies, the Accounting Reference Date is the last day in the month on which its anniversary falls. The following Accounting Reference Date would fall on the same date in subsequent years unless changed.
						</p>

						<p>
							Private companies have up to 9 months and Public companies 6 months to submit their accounts after the end of the Accounting Reference Period.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<h3>
							Why change the Accounting Reference Date?
						</h3>

						<p>
							You can change the accounting reference date by extending the accounting reference period or otherwise reducing it. To do this you must notify Companies House with Form AA01. This must be submitted before the accounts fall due.
						</p>

						<p>
							A Company may change its accounting reference date for any reason including:
						</p>

						<ul>
							<li>
								Aligning accounting reference dates for all company members of a group
							</li>
							<li>
								Convenience of accounts preparation at certain times of the year as opposed to other times
							</li>
							<li>
								For Tax planning purposes to extend the time required to pay tax liabilities
							</li>
						</ul>

						<h3>
							Restrictions to changing the Accounting Reference Date?
						</h3>

						<p>
							You may shorten the accounting reference period as often as you choose and by as many months as you decide however the following restrictions must be noted whilst attempting to extend the accounting reference period:
						</p>

						<ul>
							<li>
								Unless the company is in administration you cannot lengthen the accounting reference period beyond 18 months from the start of the accounting period
							</li>
							<li>
								As above, unless the company is in administration or the secretary of state approves it you may not extend more than once in 5 years
							</li>
						</ul>

						<p>
							Once an order is placed, Prime Formations would help complete Form AA01 and submit the same or wherever possible obtain the companies authentication code and deliver same online.
						</p>

						<p>
							We charge &pound;19.89 plus VAT to change the Accounting Reference Date.
						</p>
						...
						<p>
							The accounting reference date should be updated by Companies House within 12-24 hours.
						</p>
						...
						<h3>
							Are there any other hidden costs incurred under the Change of Accounting Reference Date Service?
						</h3>

						<p>
							Our Change of Accounting Reference Date Service has no hidden costs. The cost of the service is as stated. We charge &pound;19.89 plus VAT per effected change as above. Anyone may access this service as it is not restricted to companies incorporated by us.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
