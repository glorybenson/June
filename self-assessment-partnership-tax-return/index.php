...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-self-assessment-partnership-tax-return/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--inactive site-nav__menu--additional-services">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Self Assessment and Partnership Tax Return</a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
...
<section class="hero ptb-100" style="background-image:url(../assets/custom/images/57.png);">
	...
	<div class="container">
		...
		<div class="row pd-top-50 pd-bot-20">
			...
			<div class="col-12">
				<h1>
					Self Assessment And Partnership Tax Returns Service
				</h1>
			</div>
			<!-- End Col -->
		</div>
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						...
						<p>
							Our Self Assessment And Partnership Tax Return is a bespoke service and is only available by contacting us at 
						...
						<p>
							Self Assessment is a system of taxation employed by HMRC [Her Majesty Revenue &amp; Custom] by which income tax is collected. Income tax is a tax on salary, wages, pensions, interest, property rent, dividends and other income derived from professional, trading and investment activities.
						</p>

						<p>
							Once registered with HMRC a company director earning dividends, a self-employed tradesman or a partner in a professional firm would be required to deliver a self assessment tax return for the   from the date business commenced to 5th April of the following year. For instance, if the self-employed person started business on the 10th September 2020 then he/she would be required to produce an account for the business from 10th September 2020 to 5th April 2021 and deliver a tax return accordingly.
						</p>

						<p>
							Paper returns must be delivered by 31st October of the relevant tax year.
						</p>

						<p>
							Online returns must be delivered by 31st January of the following year.
						</p>

						<p>
							It is here expressly stated, that the fees quoted for the various tax services on offer relate to a turnover not exceeding &pound;100,000. An incremental fee of &pound;100 applies per additional &pound;50,000 Turnover.
						</p>
						...
						<p>
							Our Tax and Accounting Division-Prime Formations Partnership (a Firm of Qualified Accountants) would register you online for Self Assessment purposes. We can deliver Self Assessment tax returns as follows:
						</p>
						...
						<p>
							Once you place an order for this service, we would send by email a Directors Self Assessment Questionnaire and our Schedule of Tax Computations Requests detailing what we require in order to produce the tax computations. The Self Assessment return can be delivered under two different time regimes. It is implied under Director Self Assessment Tax Return that we would be dealing with Dividend income, Salary income, P11ds and other income accrued from directorship roles but no trading accounts.
						</p>

						<h4>Regular Service &pound;129.89 PLUS VAT</h4>

						<p>
							If we receive all answers to our requests the Self Assessment Tax return would be available for HMRC submission within 21 working days and our charge for this service is &pound;129.89 plus VAT
						</p>

						<h4>Fast Track Service &pound;229.89 PLUS VAT</h4>

						<p>
							If we receive all answers to our requests the Self Assessment Tax Return would be available for HMRC submission within 10 working days and our charge for this service is &pound;229.89 plus VAT
						</p>

						<h3>
							2. Trade/Business/Partners Self Employed Assessment Tax Return
						</h3>

						<p>
							Once you place an order for this service, we would send by email a Self-employed Assessment Questionnaire and our Schedule of Accounts Production Requests detailing what we require to produce the Accounts and Tax Computations. The Self Assessment Return can be delivered under two different time regimes:
						</p>

						<h4>Regular Service &pound;249.89 Plus VAT</h4>

						<p>
							If we receive all answers to our requests the Partnership Tax Return would be submitted to HMRC within 21 working days and our charge for this service is &pound;249.89 plus VAT.
						</p>

						<h4>Fast Track Service &pound;349.89 Plus VAT</h4>

						<p>
							If we receive all answers to our requests the Partnership Tax Return would be submitted to HMRC within 10 working days and our charge for this service is &pound;349.89 plus VAT.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
			...
			<div class="col-lg-5 col-md-12">
				...
				<div class="widget widget_search">
					<h2 style="font-size: 20px; font-weight: 10px;">
						Cost: &pound;129.89 +VAT(Regular)
					</h2>

					<h2 style="font-size: 20px; font-weight: 10px;">
						Cost: &pound;229.89 +VAT(Fast Track)
					</h2>
				</div>
