                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php"> Transfer of Shares </a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
                        ...
                        <p>
							Our Transfer Of Shares Service is a bespoke service and is only available by contacting us at 
						...
						<p>
							The transfer of shares in any UK registered company can be effected at any time during the corporate existence of the company. A shareholder may decide to transfer his/her shares for several reasons which may include:
						</p>

						<ul>
							<li>
								Tax planning exercises such as the transfer of shares into a tax-efficient scheme such as ISA, Pension schemes
							</li>
							<li>
								Share transfers between business partners as part of a Shareholder Agreement
							</li>
							<li>
								Share transfers occasioned by the death of a shareholder as specified in a will
							</li>
							<li>
								Transfer of shares between husband and wife as part of tax planning
							</li>
							<li>
								Corporate structure arrangements as a part of a company takeover, setting up a subsidiary or associate company
							</li>
						</ul>
						...
						<ul>
							<li>
								The directors must ensure they have checked all provisions of the Articles of Association, Shareholder Agreement, and all rights of pre-emption and that no restrictions to the transfer of shares apply.
							</li>
							<li>
							...
							<li>
								Alternatively you may complete and file a Confirmation Statement [available at our standard fee of &pound;55.00 plus VAT. This fee is in addition to the above Transfer of Shares fee] Changes to the shareholding of a company would only be noted on the public register when a Confirmation Statement and Form J30 is completed and filed with Companies House.
							</li>
							<li>
								Our required documentation for the transfer of shares include the following:
								<ul>
									<li>
										<span class="fw-bolder">
											Completion of the Stock Transfer Form J30 
										</span>
										&ndash; A transferor [shareholder transferring his/her shares] must complete and sign the J30 form detailing his/her name, address, and details of shares being transferred such as the quantity, class and type, and the chargeable consideration.
									</li>
									<li>
										<span class="fw-bolder">
											The buyer or transferee must provide his/her name and address on Form J30. 
										</span>
										Where more than one class of shares is being transferred a separate J30 form must be completed for each class of shares.
									</li>
									<li>
										Where the value of shares transferred exceed &pound;1000 
										<span class="fw-bolder">
											Form J30 must be stamped by HMRC 
										</span>
									...
									<li>
										...
										- The directors are required to hold meetings and record in the minutes of meeting decisions reached in the governance and management of the company including approvals of the transfer shares by existing shareholders.
									</li>
									<li>
										The 
										<span class="fw-bolder">
											company must cancel old share certificates 
										</span>
										and issue new certificates as required
									</li>
								</ul>
							</li>
						</ul>
						...
						<p>
							All documents are digitally delivered where paper copies are required a small fee may apply.
						</p>

						<p>
							The update of the statutory register is not included in this fee neither is the stamp duty payable to HMRC if applicable.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<h3>
							Are there any other hidden costs incurred under the Transfer of Shares Service?
						</h3>

						<p>
							Our Transfer of Shares Service has no hidden costs. The cost of the service is as stated. We charge &pound;55.00 plus VAT. The fee stated however does not include an update of the Statutory registers neither does it include Stamp Duty payable to HMRC if applicable. Anyone may access this service as it is not restricted to companies incorporated by us.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
