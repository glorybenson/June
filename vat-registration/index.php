                                        ...
                                        <div class="site-nav__menu site-nav__menu--inactive site-nav__menu--additional-services">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">VAT Registration</a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
                        ...
                        <p>
							Our VAT Registration is a bespoke service and is only available by contacting us at 
						...
						<p>
							Value Added Tax is a tax on the supply of goods and services for a consideration made by a registered taxable person in the UK in the ordinary course of business. A taxable person can be an Individual, Company, Partnership, LLP, Club, Society, Association, Charity or Trust.
						</p>

						<p>
							VAT can be charged at the standard rate of 20%, at the reduced rate of 5% or at 0%. Other taxable supplies may be exempt or outside the scope of VAT.
						</p>

						<p>
							The VAT threshold for compulsory registration is &pound;85,000. Therefore, if your taxable supplies already exceed &pound;85,000 you need to register immediately or if your taxable supplies would exceed the &pound;85,000 within 30 days you need to register now.
						</p>

						<p>
							Voluntary registration is also available. Companies with turnovers below &pound;85,000 may register for VAT purposes to reduce the VAT burden and to appear much larger than they are.
						</p>
						...
						<p>
							Prime Formations provides a bespoke VAT registration service and we are at hand to advise on the peculiarities of your requirements.
						</p>

						<p>
							We charge &pound;45.00 plus VAT for VAT registration for one company or individual as we can register both companies and individuals for VAT.
						</p>
						...
						<p>
							Should you wish to deregister we offer such services at &pound;39.99 plus VAT. The VAT deregistration threshold for the 2021/2022 tax year is &pound;83,000. Please click the order button and follow the payment process to access this service.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<p>
							Our Tax and Accounting Division-Prime Formations Partnership (a Firm of Qualified Accountants) would register you online for VAT purposes. Once you place an order, we would forward by email a VAT Registration Questionnaire which captures every information required in completing the VAT application. Once completed HMRC would send you a VAT registration letter with your VAT number. The process may take 30-40 days.
						</p>
			...
			<div class="col-lg-5 col-md-12">
				...
				<div class="widget widget_search">
					<h2 style="font-size: 20px; font-weight: 10px;">
						Registration Cost: &pound; 45.00 +VAT
					</h2>

					<section class="widget">
						<h2 style="font-size: 20px; color: blue; font-weight: 8px;">
							Deregistration Cost: &pound; 39.00 +VAT
						</h2>

						<div class="others-option" style="text-align: center;">
							<a class="default-btn" href="../vat-deregistration/index.php">
								Deregistration 
							</a>
						</div>
					</section>
