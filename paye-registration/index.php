                                        ...
                                        <div class="site-nav__menu site-nav__menu--inactive site-nav__menu--additional-services">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Paye Registration</a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
                        ...
                        <p>
							Our Paye Registration is a bespoke service and is only available by contacting us at 
						...
						<p>
							The UK based PAYE system applies to monetary income from employments or stated offices such as salaries, taxable expenses, wages, honoraria, fees, commissions, pensions and bonuses. Employers operate the Real Time Information [RTI] PAYE system on behalf of HMRC as they calculate the net pay for each staff, the applicable income tax and Class 1 National Insurance Contributions payable on gross salaries, wages, taxable expenses and bonuses. Employers subsequently hand over the payroll information schedule, monthly tax and National Insurance Contributions to HMRC in real time.
						</p>

						<p>
							The PAYE system is the means of collecting income tax by the Government. Income Tax generates a significant portion of the UK Government&rsquo;s annual revenue.
						</p>

						<p>
							You have to enrol for PAYE registration if you employ any staff or have income-earning directors.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<p>
							Our Tax and Accounting Division-Prime Formations Partnership (a Firm of Qualified Accountants) would deliver PAYE Registration online. Once you place an order, we would forward by email a PAYE Registration Questionnaire which covers every information required in completing the PAYE registration process. Once the PAYE Application is completed we would file the same with HMRC and expect to receive a PAYE Registration acknowledgement notice within 5 days. This would be forwarded to you once received.
						</p>

						<p>
							We expect your company to be PAYE registered with your PAYE Employment Reference and Accounting Office Reference available within 30 days.
						</p>
