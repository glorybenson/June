...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-company-dissolution/">
        ...
        <div id="wrapper">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                <div class="site-nav__menu-col-one">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Company Dissolution</a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
            ...
            <!-- End Header -->
<!-- Hero Section -->
<section class="hero ptb-100" style="background-image:url(../assets/custom/images/55.png);alt=" tall="" building"="">
	<!-- Container -->
	<div class="container">
		<!-- Row -->
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<h4>Company Dissolution</h4>

						<p>
							Our Company Dissolution Service is a bespoke service and is only available by contacting us at 
						...
						<p>
							At Prime Formations, our Company Dissolution Service helps you dissolve your company if you no longer want it. A company may not be required if you are no longer trading, have never traded, or no longer wish to take your business idea forward. You may also wish to dissolve a company to save time and money filing annual accounts and Confirmation Statements. You may also wish to avoid involuntary dissolution, late filing penalties, and possible prosecutions arising therefrom.
						</p>

						<p>
							A company can be dissolved by completing the DS01 Companies House Form.
						</p>

						<p>
							We would handle the process of dissolution but would require you to sign the Board of Directors Meeting initiating the dissolution with an electronic signing of DS01.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<p>
							A voluntary dissolution process can only be initiated if you have followed certain procedures such as informing relevant parties involved in the business of your decision to dissolve the company. Shareholders, other directors, employees (if any) would need to be officially informed. Interested parties such as creditors and HMRC must also be informed.
						</p>

						<p>
							Your company may however not qualify for voluntary dissolution if you have changed your name within the last 3 months, have traded or sold stock in the last 3 months, have entered into a credit agreement, or about to initiate the liquidation process of winding down a company.
						</p>

						<p>
							The Dissolution Form DS01 has to be completed and signed by the directors with an enclosed Companies House fee. Once the striking off process is initiated you would need to close the company&rsquo;s bank account otherwise at dissolution you would forfeit any bank balance to the Crown.
						</p>

						<p>
							It could take 2-3 months to strike-off a company from the Companies House public register.
						</p>
						...
						<h3>
							Are there any other hidden costs incurred under the Company Dissolution Service?
						</h3>

						<p>
							Our Company Dissolution Service has no hidden costs. The cost of the service is as stated. We charge &pound;55.00 plus VAT for the service.
						</p>
