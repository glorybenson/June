...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-vat-quarterly-returns/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--inactive site-nav__menu--additional-services">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">VAT Quarterly Returns</a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<h4>VAT Quarterly Returns</h4>
                        <p>
							Our VAT Quarterly Returns is a bespoke service and is only available by contacting us at 
						...
						<p>
							VAT quarterly returns are legal requirements for taxable persons under the VAT regime. There are different VAT regimes under which VAT registrable persons can operate such as the Cash Accounting scheme, the Annual Accounting scheme and the Flat Rate Scheme. All VAT schemes require that a VAT return be delivered under the &lsquo;Making Tax Digital regime&rsquo; once a quarter, 1 calendar month and 7 days after the end of the VAT accounting period.
						</p>

						<p>
							A taxable person must charge VAT on taxable supplies to customers called output tax and claim credit for tax paid on purchases known as input tax.
						</p>

						<p>
							Adequate records must be kept by the taxable person to provide evidence of the transactions making up the VAT return.
						</p>

						<p>
							A taxable person must submit a return stating:
						</p>
						...
						<ul>
							...
							<li>
								The Amount of VAT reclaimed
							</li>
							<li>
								VAT Refund from HMRC or
							</li>
							<li>
								VAT Payable to HMRC
							</li>
						...
						<p>
							A VAT return must be submitted even where there is no VAT to pay or reclaim.
						</p>

						<p>
							A VAT return can be delivered through the HMRC free online system or through commercial accounting software under the &lsquo;Making Tax Digital Regime&rsquo; operational from 6th April 2019.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<p>
							Our Tax and Accounting Division-Prime Formations Partnership (a Firm of Qualified Accountants), would deliver quarterly VAT returns as required. Once you place an order, we would forward by email a VAT return accounting questionnaire detailing every information required in completing the quarterly VAT return. Once completed we would forward the same to you for your input before filing with HMRC. To avoid surcharges and penalties all information for VAT quarterly returns production must be received 2 weeks after the end of the quarterly accounting period.
						</p>
