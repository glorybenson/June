...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-corporation-tax-returns/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--inactive site-nav__menu--additional-services">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Corporation Tax Returns</a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<h4>Corporation Tax Returns</h4>
                        <p>
							Our Corporation Tax Returns is a bespoke service and is only available by contacting us at 
						...
						<p>
							Limited Liability Companies, Unincorporated Associations and other Corporate Bodies with income and capital gains are taxed under a direct tax regime called Corporation Tax.
						</p>

						<p>
							Companies and individuals were taxed under income tax rules until the Finance Act of 1965 introduced Corporation Tax as a separate form of business taxation.
						</p>

						<p>
							According to the Corporation Tax Act 2010, all Company income from any source which is within the charge of Corporation Tax is subject to reliefs. Such reliefs include specific expense reliefs, tax reliefs and specific deductions.
						</p>

						<p>
							Companies resident in the UK are required to self assess and pay Corporation Tax on their taxable total profits worldwide. Companies or corporate bodies not resident in the UK are chargeable to Corporation Tax on the profits of any UK based &lsquo;Permanent Establishment&rsquo; carrying out a trade in the UK
						</p>

						<p>
							A Company must submit an Annual Corporation Tax return to HMRC by filing the CTSA Form CT600 entirely online using available commercial software. The accounts must be in iXBRL format. A company is required to submit a tax return 12 months from the end of its accounting period.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<p>
							Our Tax and Accounting Division-Prime Formations Partnership (a Firm of Qualified Accountants) would deliver Corporation Tax Returns on your behalf as follows
						</p>

						<h3>
							Inhouse Accounts Produced by Prime Formations Partnership
						</h3>

						<p>
							Inhouse Accounts produced by Prime Formations Partnership with a further requirement for Corporation Tax filing is charged at &pound;99.89 plus VAT
						</p>

						<h3>
							External Accounts Produced by Others
						</h3>

						<p>
							External Accounts produced by other accounting firms or accountants with a further requirement for Corporation Tax filing would be charged at &pound;400.00 plus VAT.
						</p>
