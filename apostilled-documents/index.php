...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-apostilled-documents/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Apostilled Documents</a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
                        <p>
							Our Apostilled Documents Service is a bespoke service and is only available by contacting us at 
						...
						<p>
							A UK registered limited liability company owned by non-UK residents may be required to legalise their Companies House incorporation documents for use by foreign authorities overseas. Such foreign authorities may require the verification of the genuineness or authenticity of the said documents.
						</p>

						<p>
							Such authenticity may be required where your company wishes to establish a foreign branch or open a business bank account abroad.
						</p>

						<p>
							Any document issued by Companies House such as:
						</p>
						...
						<p>
							may be legalised by a notary [UK-based Practising Solicitor] and then forwarded for authentication or verification to the Foreign, Commonwealth and Development Office [FCDO] for the issuance of an apostille certificate.
						</p>

						<p>
							Only countries who have signed up to the Hague Convention of 1961 would accept the apostilled certificate. Countries not signed up to the Hague Convention of 1961 may not accept the verified documents.
						</p>

						<p>
							Please be aware that our fees of &pound;89.89 plus VAT is per document requiring authentication. For instance, if you require 5 documents to be apostilled you would be required to pay &pound;89.89 plus VAT per document.
						</p>

						<p>
							Once the apostille certificate is obtained per document the documentation is posted by Royal Mail Special Delivery or international tracked signed mail service at no extra charge to any country in the world. Where you require courier delivery services such as DHL we can arrange for this at an additional fee.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<h3>
							Are there any other hidden costs incurred under the Apostilled Documents Service?
						</h3>

						<p>
							Our Apostilled Documents Service has no hidden costs. The cost of the service is as stated. We charge &pound;89.89 plus VAT per document verified. Please be aware that our fees at &pound;89.89 plus VAT is per document requiring authentication. For instance, if you need to authenticate 5 documents you would be required to pay &pound;89.89 plus VAT per document. Anyone may access this service as it is not restricted to companies incorporated by us.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
