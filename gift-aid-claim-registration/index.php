...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-gift-aid-claim-registration/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--inactive site-nav__menu--additional-services">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Gift Aid Claim Registration</a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<h4>Gift Aid Claim Registration</h4>
                        <p>
							Our Gift Aid Claim Registration is a bespoke service and is only available by contacting us at 
						...
						<p>
							Charities and Community Amateur Sports Club [CASC] must register with HMRC to claim Gift Aid. Gift aid is a UK tax incentive scheme managed by HMRC on behalf of the UK Government which allows Charities to reclaim the tax already paid on donations. Individuals give donations through their income, wages, salaries or the sale of capital assets subject to Capital Gains tax.
						</p>

						<p>
							Tax relief on donations made through these avenues can be reclaimed by the Charity receiving the donation as long as the following conditions are present:
						</p>

						<ul>
							<li>
								The Charity must be based in the UK, EU, Iceland, Liechtenstein or Norway
							</li>
							<li>
								The Charity must be established for charitable purposes only. Charitable purposes may include relieving poverty, education, religion, health, saving lives, citizenship or community development, amateur sports, human rights and the arts, amongst others
							</li>
							<li>
								The Charity must be registered with the Charity Commission or another approved regulator
							</li>
							<li>
								The Charity must be run by &lsquo;fit and proper persons&rsquo;
							</li>
							<li>
								The Charity must be recognised by HMRC for Gift Aid Purposes with an HMRC Gift Aid Reclaim Tax Reference
							</li>
							<li>
								The Charity must have internal and accounting processes for establishing donations received including signed Gift Aid Declaration Forms
							</li>
						</ul>
					...
					<div class="faq">
						...
						<p>
							Our Tax and Accounting Division-Prime Formations Partnership (a Firm of Qualified Accountants) Would register your Charity or Community Amateur Sports Club [CASCs] for Gift Aid purposes. Once you place an order, we would forward by email a Gift Aid Registration Questionnaire which covers every information required including Bank details, Financial Accounts, the Charity Registration Number, the Charitable Objectives and Governing document.
						</p>

						<p>
							Once the Gift Aid Registration Application is completed, we would file the same with HMRC and expect to receive a Gift Aid Registration acknowledgement notice by return through email. This would be forwarded to you once received. We expect your Charity to be registered with HMRC for Gift Aid Reclaim purposes within 8-12 weeks of applying.
						</p>

						<p>
							The cost of this service is &pound;99.89 plus VAT.
						</p>
