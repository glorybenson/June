...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-confirmation-statements/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                <div class="site-nav__menu-col-one">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Confirmation Statements</a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						...
						<p>
							The Confirmation Statement formerly the Annual Return is an annual filing requirement for all limited companies and LLP&rsquo;s incorporated in the UK. The Confirmation Statement provides an update of the Company&rsquo;s share capital, Persons of Significant Control [PSC], Standard Industrial Classification Code [SIC], Registered Office Address, Directors, Shareholders or members if an LLP. Prime Formations offer a Confirmation Statement filing service to ensure your company is compliant and up-to-date with Companies House filing requirements. Companies House would strike off any company that fails to deliver the Confirmation Statement within a stated time frame.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<p>
							The Confirmation Statement much like the Annual return preceding it, is an annual filing requirement by Companies House detailing the yearly update of for the limited company or LLP. The annual update is normally in respect of Share capital, Shareholder information, Registered Office, SIC Codes and Persons of Significant Control. The reason for this annual requirement is to ensure that limited company or LLP information on the public register of Companies House is up-to-date, relevant and accurate.
						</p>

						<p>
							A Confirmation Statement must be filed every 12 months. You may file more than once within that period if you need to make urgent changes to be reflected on the public register.
						</p>
						...
						<p>
							The Confirmation Statement must be filed after 14 days of the anniversary of the date of incorporation. In other circumstances particularly where changes have been made within the stated 12 months you would be required to file the Confirmation Statement on the anniversary of the date last filed.
						</p>

						<p>
							At Prime Formations, we have two ordering options for filing the Confirmation Statement. The Regular Option ensures the Confirmation Statement is filed within 3 working days of receiving all information required.
						</p>

						<p>
							The Fast Track Option ensures the Confirmation Statement is filed within 24 hours &ndash; 1 working day of receiving all information required.
						</p>
						...
						<h3>
							Are there any other hidden costs incurred under the Confirmation Statement service?
						</h3>

						<p>
							Our Confirmation Statement service has no hidden costs. The cost of the service is as stated. We charge &pound;35.00 plus VAT for the Regular Service and &pound;44.89 for the Fast Track Service. You must however be aware that our Confirmation Statement Service may only make adjustments in respect of Shareholder changes, changes in share capital, and changes in SIC codes. Other updates such as changes to the PSCs, company officers, or registered office address have to be notified using appropriate Companies House forms such updates would result in additional costs as specified elsewhere. Anyone may access this service as it is not restricted to companies incorporated by us.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
