...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-director-appointment/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                <div class="site-nav__menu-col-one">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Director Appointment & Resignation</a>
                                                    </li>
                                                </div>
...
<section class="hero ptb-100" style="background-image:url(../assets/custom/images/55.png);">
	...
	<div class="container">
		...
		<div class="row pd-top-50 pd-bot-20">
			...
			<div class="col-12">
				<h1>
					Director Appointment, Detail Change &amp; Termination Service
				</h1>
			</div>
			<!-- End Col -->
		</div>
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						...
						<p>
							The directors of a company are appointed to run the affairs of the business and make corporate decisions that would impact on the strategic direction of the company and its associated business or businesses. In large companies there is often a separation between management and ownership by contrast in small companies the directors are often &lsquo;owner managers&rsquo;. Directors who may be appointed at any time through out the life span of the business are appointed by preparing and filing the Companies House Form AP01. Relevant information required to appoint a director include:
						</p>
						...
						<p>
							Prime Formations, would also require the minutes of meeting by which the appointment was decided and agreed upon by shareholders of the company.
						</p>

						<p>
							We charge &pound;19.89 plus VAT per Director Appointed.
						</p>
						...
						<h3>
							Director Detail Change
						</h3>

						<p>
							The details of the appointed directors would often change throughout their tenure and stewardship of the company. To be legally compliant, the company has to notify the Companies House of any such change. Such changes may include change of:
						</p>
						...
						<p>
							Change of Directors details are prepared and filed by completing the Companies House Form CH01.
						</p>

						<p>
							We charge &pound;19.89 plus VAT per Director change effected.
						</p>
						...
						<p>
							A director may resign his or her appointment with the company at any time or the shareholders may likewise decide to terminate his or her appointment for any reason.
						</p>

						<p>
							Minutes of meeting must be kept and forwarded to us in order to effect these changes with the Companies House. A letter of resignation or termination of services would need to be provided as well.
						</p>

						<p>
							Prime Formations, would prepare and file the Companies House Form TM01.
						</p>

						<p>
							We would require the following information to effect this:
						</p>

						<p>
							Current Details of the Director on the Register such as:
						</p>
						...
						<ul>
							...
							<li>
								Corporate Name [If a Corporate Director]
							</li>
						</ul>

						<p>
							We charge &pound;19.89 plus VAT per Director termination of appointment effected.
						</p>
						...
						<p>
							For all three services printed documents may be supplied at an additional fee.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<h3>
							Are there any other hidden costs incurred under the Director Appointment, Detail Change and Director Termination Service?
						</h3>

						<p>
							Our Director Appointment, Detail Change, and Director Termination Service have no hidden costs. The cost of the service is as stated. We charge &pound;19.89 plus VAT per effected change as above. Our fees however do not include updates of the Statutory registers nor the supply of printed documents if so required. Anyone may access this service as it is not restricted to companies incorporated by us.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
