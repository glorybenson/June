                                        ...
                                        <div class="site-nav__menu site-nav__menu--inactive site-nav__menu--additional-services">
                                            <ul class="site-nav__menu-links">
                                                <div class="site-nav__menu-col-one">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Cashplus Bank Account</a>
                                                    </li>
                                                </div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<img alt="Cashplus Logo" class="img-fluid" src="../assets/custom/images/cashplus-logo.png">
						<h3>
							The Business Current Account for Small Businesses
						</h3>
						...
						<p>
							With UK based customer service, as well as 24/7 mobile and online account access, the account is the ideal low hassle way to manage your business finances.
						</p>

						<p>
							As no credit check is required to apply, the account can be applied for instantly online, with the Account Number and Sort Code being available at the end of the application process for successfully verified customers.
						</p>

						<p>
							The application only takes minutes, with approved applicants enjoying the following benefits:
						</p>

						<ul>
							<li>
								Manage the account on any device anywhere 24/7
							</li>
							<li>
								Integrated with major Accountancy Packages
							</li>
							<li>
								UK customer service
							</li>
							<li>
								Single annual fee of just &pound;69*
							</li>
							<li>
								No charges for inbound transfers or setting up Direct Debits
							</li>
							<li>
			...
			<div class="col-lg-5 col-md-12">
				<!-- Aside -->
				<aside class="widget-area" id="secondary"><!-- Package Features -->
				<section class="widget">
					...
					<p>
						There are three ways to order our service if you are new and don&#39;t currently have a company, it&rsquo;s possible to request this service when you officially form your company. Alternatively, if you currently have a company and are a brand-new customer, you can create an account with Delta Legal and Corporate. And finally, if you currently have an account with us, all you need to do is log in, follow the process of purchasing our service and checkout.
					</p>
					&nbsp;
