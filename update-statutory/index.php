                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Update all five Statutory Registers [Annual]</a>
                                                    </li>
                                                </div>
                                            </ul>
                                        </div>
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
                        ...
                        <p>
							Our Statutory Registers Service is a bespoke service and is only available by contacting us at 
						...
						<p>
							All private limited companies are required by law to maintain a statutory register, make changes as required and update the register accordingly.
						</p>

						<p>
							A Statutory register is an official document required by law to be maintained by private companies.
						</p>

						<p>
							The five statutory registers are:
						</p>
						...
						<p>
							A company may elect to keep all statutory registers at the registered office, or Single alternative inspection location [SAIL] address.
						</p>

						<p>
							Prime Formation provides a statutory update service for companies who have elected to maintain such registers with us. Our service ensures that your company secretarial detail is kept up to date throughout the year according to the law.
						</p>

						<p>
							The Small Business Enterprise and Employment Act 2015 makes provision for private companies to elect to maintain their statutory register on the public register of Companies House. From 30 June 2016, a private company can make an election to send information previously kept in any certain statutory register to the registrar of companies to be kept on the public register at Companies House. Anyone can inspect and take copies of information from the public register. Sensitive information such as date of birth and residential address would be available on the public register.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<ul>
							<li>
								We would appoint a dedicated legal executive to handle your account continuously throughout the year to ensure continuity and facilitate an ongoing relationship.
							</li>
							<li>
								The Legal executive would be on hand to take your instructions and update the register as required.
							</li>
							<li>
								Preparation and Maintenance of the five statutory registers as laid out in the Companies Act 2006.
							</li>
							<li>
								The first four changes including director appointments, termination of appointments, change of address, share transfers etc are deemed to be included in our fee and is therefore free. Further transactions within the same 12 month period would attract a fee based on the nature of the change.
							</li>
							<li>
								Once an order is completed we would prepare your statutory registers and forward the same to you by email.
							</li>
							<li>
								Regular updates would be forwarded to you as requested
							</li>
						</ul>
						...
						<h3>
							Are there any other hidden costs incurred under the Statutory Registers Update Service?
						</h3>

						<p>
							Our Statutory Registers Update Service has no hidden costs. The cost of the service is as stated. The statutory register update is charged at &pound;95.00 plus VAT renewable annually at your request. Our legal executive would be available to ascertain your instructions and act on them within our working hours of 9.00am to 5.00pm. Other registers such as Register of Allotment of Shares, Register of Share Transfers, and Register of Directors&rsquo; usual addresses, may also be kept for an extra fee. The first four changes including director appointments, termination of appointments, change of address, share transfers etc are deemed to be included in our fee and is therefore free. Further transactions within the same 12 month period would attract a fee based on the nature of the change. Anyone may access this service as it is not restricted to companies incorporated by us.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
