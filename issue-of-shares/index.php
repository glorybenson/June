  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <body id="ef-issue-of-shares/">
        ...
        <div id="wrapper">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Issue of Shares </a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
            ...
            <!-- End Header -->
<!-- Hero Section -->
<section class="hero ptb-100" style="background-image:url(../assets/custom/images/55.png);">
	<!-- Container -->
	<div class="container">
		<!-- Row -->
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<h4>Issue Of Shares</h4>
                        <p>
							Our Issue Of Shares Service is a bespoke service and is only available by contacting us at 
						...
						<p>
							The issue of shares is the process by which Companies pass on shares to new or existing individual or corporate shareholders. Shares may be issued at the very start of the company&rsquo;s corporate life or at any other point of its corporate existence. Companies may issue the same class of shares or a different class of shares with different voting rights as required. Whilst the issue of shares and share allotment are different technically, they serve very similar purposes as they both describe the process of issuance of shares to new or existing members who then become shareholders or owners of the company.
						</p>

						<p>
							This is to be differentiated from share transfer which involves existing company shares being passed from one existing shareholder to another. The first shareholders at the incorporation of the company are termed &lsquo;subscribers&rsquo;.
						</p>

						<p>
							The initial subscription to shares and subsequent issue of shares is undertaken to raise finance, pay debts, grow the company from within, project fund, or fund the purchase of another company amongst others.
						</p>
						...
						<ul>
							<li>
								In opening a Bank Account it is usual for Commercial Banks to request proof of share ownership either via an Accountant&rsquo;s Letter [available at a fee of &pound;49.89 plus VAT]
							</li>
							<li>
								Alternatively you may complete and file a Confirmation Statement [available at our standard fee of &pound;65.00 plus VAT. This fee is in addition to the above issue of shares fee] Changes to the shareholding of a company would only be noted on the public register when a Confirmation Statement and Form SH01 is completed and filed with Companies House
							</li>
							<li>
								Our required documentation for the issuance of shares include the following:
								<ul>
									<li>
										<span class="fw-bolder">
											Application Letter 
										</span>
										&ndash; A shareholder should express his/her desire to purchase additional shares at a specified price per share addressed to the company in compliance with the legal specifications of the company&rsquo;s Article of Association.
									</li>
									<li>
										<span class="fw-bolder">
											Minutes of Meeting 
										</span>
										- The directors are required to hold meetings and record in the minutes of meeting, decisions reached in the governance and management of the company including decisions to issue new shares and the approval of the allotment of shares to specific persons.
									</li>
									<li>
										<span class="fw-bolder">
											Special Resolution by the existing shareholders 
										</span>
										would be required where issuance of shares is considered for new shareholders. Companies incorporated under the Companies Act 1985 with an Authorised share capital would have a pass a special resolution to amend the Articles of Association and remove the restrictions imposed by an Authorised share capital.
									</li>
									<li>
										<span class="fw-bolder">
											Companies House Form SH01 
										</span>
										in respect of the Return of Allotment of Shares must be completed and delivered to Companies House within one month of the issuance of shares to avoid committing an offence under Companies Act 2006.
									</li>
									<li>
										<span class="fw-bolder">
											Share Certificates 
										</span>
										must be issued within two months of an issue of shares.
									</li>
								</ul>
							</li>
						</ul>
						...
						<p>
							The update of the statutory register is not included in this fee.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<p>
							Accountants, Estate Agents, Solicitors, and other professionals including Formation Agents such as ourselves are required by law-The Money Laundering and Terrorist Financing (Amendment) Regulations 2019 and previous Money Laundering Regulations to check proof of ID and Address. We are required to carry out digital ID checks on our customers and most do not have to do anything else except complete the online formation form. A very minute percentage of our customers may need to supply further information if they fail the digital ID tests or are not eligible for one.
						</p>

						<h3>
							Are there any other hidden costs incurred under the Issue of Shares Service?
						</h3>

						<p>
							Our Issue of Shares Service has no hidden costs. The cost of the service is as stated. We charge &pound;65.00 plus VAT. The fee stated however does not include an update of the Statutory registers. Anyone may access this service as it is not restricted to companies incorporated by us.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
