                                        ...
                                        <div class="site-nav__menu site-nav__menu--inactive site-nav__menu--additional-services">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-three">
                                                    <h3>Accounts</h3>
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Dormant Financial Accounts</a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<h4>Dormant Financial Accounts</h4>
                        <p>
							Our Dormant Financial Accounts Service is a bespoke service and is only available by contacting us at 
						...
						<p>
							A Private Limited Company, LLP, Charity or Charitable Company and Community Interest Company [CIC] are regarded as dormant if it has had no significant transactions within the accounting period. A significant accounting transaction is recorded in the accounting records of the company may well indicate that the company was trading in the accounting period. Such transactions may include buying and selling of goods in the ordinary course of business, buying assets to run the business. Transactions with debtors, creditors and lenders.
						</p>

						<p>
							However, the transactions detailed below cannot be regarded as significant accounting transactions. Dormant companies may record:
						</p>
						...
						<ul>
							...
							<li>
								Fees paid to the Registrar of Companies for filing annual returns, change of company details
							</li>
							<li>
						...
						<p>
							A dormant company is expected to keep accounting records. It is not anticipated that a dormant company would have to maintain most of the records detailed below. Accounting records among other things must contain:
						</p>

						<ul>
							<li>
								Entries detailing all money received and expended by the company. Records of income and expenditure of the company must be adequately kept. The records kept form the basis for preparing the profit and loss account
							</li>
							<li>
						...
						<p>
							At Prime Formations, we have designed our Dormant Company Account Service to help you fulfil your responsibilities of delivering accounts to Companies, HMRC and other regulatory bodies such as the Charity Commission.
						</p>

						<p>
							Companies House Paper Form AA02 can be downloaded and completed for companies that have never traded from incorporation.
						</p>

						<h3>
							What does a Set of Dormant Accounts include?
						</h3>

						<p>
							A set of Dormant Accounts must include the following:
						</p>

						<ul>
							<li>
								An Abbreviated Balance Sheet signed by a named director with his printed name inserted on the statement on behalf of the Board of Directors
							</li>
							<li>
								Directors Report to Members
							</li>
							<li>
								Any previous year&rsquo;s figures for comparison
							</li>
							<li>
						...
						<p>
							A Dormant Company is required to deliver Dormant Company Accounts to Companies House within 9 months after the Accounting Reference Date and for newly formed Companies- accounts must be delivered within 21 months from incorporation date. The filing deadlines are entrenched in the Companies Act 2006 and must be strictly complied with to avoid a civil penalty starting at a minimum fine of &pound;150 and graduating to &pound;1,500 or more on a time defined basis. It is a criminal offence not to file your dormant company accounts within the stipulated filing deadlines.
						</p>
						...
						<p>
							Once you place an order for this service, we would send by email an Accounts Production Schedule of Requests detailing what we require in order to produce your dormant financial accounts. During the process of the Accounts Production, we would liaise with you by email to ensure all accounting queries are fully answered, any missing document notified to you and supplied and any unclear transactions appropriately dealt with. Once the accounts are produced, we would arrange an appropriate time to chat online about your accounts and finalise the same with you. We do not expect any tax liability to arise therefrom however a dormant company may make a loss and the implications of the same for your Corporation Tax filing were registered for this purpose.
						</p>

						<p>
							Please note that the fee charged is strictly for the Dormant Company Accounts Production Service. We charge separately for Corporation Tax filing.
						</p>

						<h3>
							Regular Service &pound;49.89 plus VAT
						</h3>

						<p>
							If we receive all answers to our requests the Dormant Company Accounts would be available for Companies House submission within 10 working days and our charge for this service is &pound;49.89 plus VAT. Please note that this service is for Dormant Companies, LLPs, CICs and Charitable Companies with a zero turnover.
						</p>
						...
						<h3>
							Fast Track Service &pound;99.89 Plus VAT
						</h3>

						<p>
							If we receive all answers to our requests the financial accounts would be available for Companies House submission within 1 working day or 24 hours and our charge for this service is &pound;99.89 plus VAT. Please note that this service is for dormant companies, LLPs, CICs and Charitable Companies with a zero turnover.
						</p>
					...
					<div class="faq">
						...
						<p>
							Our Dormant Company Accounts service is available to anyone and therefore not restricted to companies formed by ourselves.
						</p>
						...
						<p>
							If your company has subsequent years [not 1st year] outstanding accounts submission obligations to Companies House we can offer this service to you. Anyone can apply for this service as it is not restricted to companies formed by ourselves.
						</p>
			...
			<div class="col-lg-5 col-md-12">
				...
				<div class="widget widget_search">
					<h2 style="font-size: 20px; font-weight: 10px;">
						Cost: &pound;49.89 +VAT (Regular)
					</h2>

					<h2 style="font-size: 20px; font-weight: 10px;">
						Cost: &pound;99.89 +VAT (Fast Track)
					</h2>
				</div>
