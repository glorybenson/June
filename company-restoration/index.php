...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-company-restoration/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                <div class="site-nav__menu-col-one">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Company Restoration </a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<h4>Company Restoration</h4>
                        <p>
							Our Company Restoration Service is a bespoke service and is only available by contacting us at 
						...
						<p>
							At Prime Formations, our Company Restoration Service helps you restore your company to the Companies House public register if dissolved within the last 6 years. There are two ways by which a company can be restored by:
						</p>
						...
						<p>
							The registrar can restore a company to the Companies House public register if he receives a court order. If the company is dissolved by voluntary dissolution [Section 1003] it can only be restored through a court order. A former director, member, creditor, liquidator, or a person with contractual relations with the company can apply through the courts to restore the company.
						</p>

						<p>
							Unfortunately, we cannot help with this process.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<p>
							Where a company was dissolved because it appeared not to be trading, a former director or member may apply to the registrar to have the company restored. This process is called Administrative Restoration.
						</p>

						<p>
							Section 1025 of the Companies Act 2006 provides details of the requirements as it relates to Administrative Restoration. Once restored the company would be deemed to have continued in existence as if it was never dissolved.
						</p>

						<p>
							You are unable to apply for Administrative Restoration where the directors voluntarily applied to dissolve the company.
						</p>
						...
						<p>
							An application for Administrative Restoration form RT01 must be completed and sent to the registrar. This must include a statement of compliance detailing the applicant&rsquo;s legal entitlement to make the application and stating that all conditions for administrative restoration are met.
						</p>

						<p>
							A Bona Vacantia [Vacant Property] waiver letter must be obtained from the relevant crown representative at an applicable fee.
						</p>

						<p>
							All penalties outstanding including late accounts filing penalty must be paid in full with all outstanding accounts and Confirmation Statements delivered when submitting Form RT01.
						</p>
						...
						<p>
							Our fees cover the registrar&rsquo;s fee for processing Form RT01 at &pound;100.
						</p>

						<p>
							The Bona Vacantia [Vacant Property] waiver fee at a minimum of &pound;60.
						</p>

						<p>
							Up to 3 Confirmation Statements overdue at a minimum of &pound;40 per outstanding year.
						</p>

						<p>
							Any outstanding late filing fee incurred before the company was dissolved would have to be paid severally by the applicant. This is not covered in the fees.
						</p>

						<p>
							Please note that late filing penalty fees can be as high as &pound;1,500 if the company was late in filing it&rsquo;s annual accounts for more than 6 months at a time.
						</p>
						...
						<h3>
							Are there any other hidden costs incurred under the Company Restoration Service?
						</h3>

						<p>
							Our Company Restoration Service has no hidden costs. The cost of the service is as stated. We charge &pound;495.00 plus VAT for the service. You must however be aware that our Company Restoration Service is limited to a maximum of three outstanding Confirmation Statements, any further outstanding paper Confirmation Statement would be invoiced separately at &pound;59.89 plus VAT.
						</p>

						<p>
							Our fee is also not inclusive of any outstanding late filing penalties incurred by the company before it was dissolved or struck off the public register.
						</p>

						<p>
							Anyone may access this service as it is not restricted to companies incorporated by us.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
