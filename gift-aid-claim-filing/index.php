...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-gift-aid-claim-filing/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--inactive site-nav__menu--additional-services">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Gift Aid Claim Filing</a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<h4>Gift Aid Claim Filing</h4>
                        <p>
							Our Gift Aid Claim Filing is a bespoke service and is only available by contacting us at 
						...
						<p>
							Gift aid is a UK tax incentive scheme managed by HMRC on behalf of the UK Government which allows Charities to reclaim the tax already paid on donations. Individuals give donations through their income, wages, salaries or the sale of capital assets subject to Capital Gains tax.
						</p>

						<p>
							Tax relief on donations made can be reclaimed by the charity receiving the donation.
						</p>

						<h3>
							Gift Aid can be reclaimed as follows:
						</h3>

						<ul>
							<li>
								Manually by Post using Form CHR1
							</li>
							<li>
								Online using the Charities Online Service
							</li>
							<li>
								Using Commercial software that works with Charities Online
							</li>
						</ul>
						...
						<p>
							The eligibility of a donation for Gift Aid is dependent on the following:
						</p>

						<ul>
							<li>
								It must be a monetary donation- donation by cash, card payments and bank transfers, not gifts of good and services
							</li>
							<li>
								Donation must be made to a UK or EU/EEA recognised Charity
							</li>
							<li>
								The donor must give the Charity a valid Gift Aid declaration in respect of the donation. The declaration can be given 4 years after the act, at the same time as the donation is given, or before the donation was given
							</li>
							<li>
								The donor or a connected person to the donor such as a family member or spouse must not receive a substantial benefit as a result of the donation
							</li>
						</ul>

						<p>
							Having understood the basics of Gift Aid claims it is important to note that Gift Aid on donations can be claimed at any point within 4 years of the donation being received.
						</p>
						...
						<p>
							Once you place an order for this service, we would send by email a Gift Aid Questionnaire detailing what we require to produce the Gift Aid Schedule and determine how much tax can be reclaimed. We would need to assess Gift Aid Declarations from donors, Bank statements for the relevant tax period, Cash/Cheque offering envelopes, an explanation of the Charity&rsquo;s audit trail of the transactions amongst others.
						</p>

						<p>
							The Gift Aid Claim Filing can be delivered under two different time regimes:
						</p>

						<h3>
							Regular Service &pound;425.00 Plus VAT per claim period
						</h3>

						<p>
							If we receive all answers to our requests, the Gift Aid Claim Form would be available for HMRC submission within 30 working days and our charge for this service is &pound;425.00 plus VAT per claim period. Please note that this Gift Aid Claim service is for Charities and CASCs with a turnover not exceeding &pound;150,000.
						</p>

						<h3>
							Fast Track Service &pound;675.00 Plus VAT per claim period
						</h3>

						<p>
							If we receive all answers to our requests, the Gift Aid Claim Form would be available for HMRC submission within 10 working days and our charge for this service is &pound;550 plus VAT per claim period. Please note that this Gift Aid Claim service is for Charities and CASCs with a turnover not exceeding &pound;150,000 per annum.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
			...
			<div class="col-lg-5 col-md-12">
				...
				<div class="widget widget_search">
					<h2 style="font-size: 20px; font-weight: 10px;">
						Cost: &pound; 425.00 +VAT(Regular)
					</h2>

					<h2 style="font-size: 20px; font-weight: 10px;">
						Cost: &pound; 675.00 +VAT(Fast Track)
					</h2>
				</div>
