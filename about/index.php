  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <body id="ef-about/">
        ...
        <div id="wrapper">
            ...
            <!-- End Header -->
<!-- Hero Section -->
<section class="hero ptb-100" style="background-image:url(../assets/custom/images/about.png);">
	<!-- Container -->
	<div class="container">
		<!-- Row -->
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						...
						<p>
							Prime formations Limited offers a new perspective to the business of incorporating Companies in the UK by offering a distinctive and progressive business service. We cater to the needs of any company through the business timeline from incorporation, systems setup, to fulfilling annual statutory obligations such as Annual Accounts Productions and Tax return filing, to business growth management and company dissolution where necessary.
						</p>

						<p>
							As an authorised Companies House efiling agent we offer a quick online company formation service often within 3-6 hours turnaround from the time of your order if within work hours. The turnaround incorporation timing is however subject to Companies House workload.
						</p>

						<p>
							We also offer a bespoke Special Formations package with unique specialisms hardly found elsewhere with particular emphasis to Charity Registration service and Community Interest Company [CIC] Formation amongst others. With our strong tax and accountancy background, we offer a unique accountancy service designed to fulfil all your tax and accounting requirements. We provide a special and curious blend of company services to cater to the ever-changing needs of our clients.
						</p>

						<p>
							We are based in the Liverpool City. From here, we offer registered office address, service address and business address service for our customers.
						</p>
					</div>
					<!-- User Actions -->
				</div>
