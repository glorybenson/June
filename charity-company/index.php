                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Charity Company </a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<p>
							Our Charity Company package is set up specifically for Charitable organisations who wish to operate through a limited by guarantee company.
						</p>

						<p>
							The Charities Act 2011 states that a &lsquo;charity is an institution which is established for charitable purposes only and is subject to the control of the High Court&rsquo;s charity law jurisdiction.&rsquo;
						</p>

						<p>
							The Charity Commission &lsquo;What makes a Charity&rsquo; Guide CC4 in respect of a &lsquo;charitable purpose&rsquo; states:
						</p>

						<ul>
							<li>
								A Charitable Purpose must fall within the descriptions of purposes in the Charities Act
							</li>
							<li>
								A Charitable Purpose must be for the public benefit
							</li>
						</ul>

						<p>
							Therefore, for an organisation to be charitable, a purpose must satisfy both of the above criteria. The purpose must be certain such that it can be enforced by the court.
						</p>

						<p>
							For the intent of establishing a charitable company you should consider whether your charitable purposes include some of the following:
						</p>
						...
						<p>
							There are much more charitable purposes that qualify, please contact us by email at 
							...
							and we would be able to assist you further.
						</p>

						<p>
							Before proceeding to incorporate please contact us as we only offer this service on a bespoke basis.
						</p>

						<p>
							Certain criteria must be fulfilled to conclude whether or not an organisation is for public benefit. First, the purpose must be beneficial and must be targeted to a certain segment of the public.
						</p>

						<p>
							We provide as part of this package, printed and digital company documents, a free domain name for one year amongst other features.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<h3>
							Charitable Company Limited By Guarantee Explained
						</h3>

						<p>
							A Charitable Company limited by guarantee is a non-profit organisation without share capital. Members who also act as guarantors of the company&rsquo;s liability agree to contribute a specific sum of money towards the company&rsquo;s liabilities in the event of insolvency and the winding up of the company. In addition to this, a charitable company must have purposes that line up with specific purposes as specified by the Charities Act 2011 and must also be for public benefit.
						</p>

						<h3>
							Which Organisations can be registered as Charitable Companies limited by guarantee?
						</h3>

						<p>
							Companies that can register as Charitable companies limited by guarantee include but are not limited to Educational institutions, Religious Institutions, Community Development and Advocacy Organisations, Medical and Health Organisations, Animal Welfare Organisations, Legal Aid Organisations, Human and Ethnic Minority Rights Organisations, and Hostel for Homeless Operators amongst others.
						</p>

						<h3>
							Key Facts about a Charitable Company Limited by Guarantee
						</h3>

						<ul>
							<li>
								Limited by guarantee companies are separate legal entities from their guarantors.
							</li>
							<li>
								The guarantors are only liable to the company&rsquo;s debts to the value of the guaranteed amount agreed upon at incorporation.
							</li>
							<li>
								A guarantor can be an individual or a corporate body. Only a single guarantor and director is needed to register a company limited by guarantee.
							</li>
							<li>
								A guarantor unlike a shareholder cannot take profits out of a company through dividends as such company profits or the excess of income over expenditure is often reinvested in the activities of the company.
							</li>
							<li>
								The Object Clause of Charitable companies must be solely charitable as dictated by Charities Act 2011.
							</li>
						</ul>

						<h3>
							Essential Requirements in forming a Company Limited by Guarantee?
						</h3>

						<p>
							The process of incorporating a charitable company is simple and straightforward. Documents, signatures and legal consultations are not required. To incorporate a Charitable Company you would need the following:
						</p>
						...
						<ul>
							...
							<li>
								The Names of the Directors/Trustees and Guarantors. Often in small charities, these roles exist in the same person. A minimum of 3 Directors/Trustees is advised.
							</li>
							<li>
								Registered Office Address and Directors&rsquo; Service Address
							</li>
							<li>
								A Guarantee Amount to be contributed by each guarantor in the event of winding up or insolvency
							</li>
						</ul>
						...
						<h3>
							Are there any other hidden cost incurred under the Charitable Company Package?
						</h3>

						<p>
							The Prime Formations &lsquo;Charitable Company Incorporation Package&rsquo; has no hidden costs. The cost of the Charitable company package is as stated. We charge &pound;89.89 plus VAT for the package which includes Companies House incorporation charge of &pound;12. There are no renewal charges and the charge is one-off.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
				...
				<section class="widget widget_categories">
					...
					<div class="service-list-pro">
						<ul>
							...
							<li>
								&nbsp; &nbsp; Email Copy of Guarantor Certificate [s]
							</li>
						</ul>

						<div class="others-option" style="text-align: center;">
							<a class="default-btn" href="..//buy/charity-package/index.php">
								Order Now 
							</a>
						</div>
					</div>
