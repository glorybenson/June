  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <body id="ef-digital-package/">
        ...
        <div id="wrapper">
                                            ...
                                            <ul class="site-nav__menu-links">
                                                <div class="site-nav__menu-col-one">                                          
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Digital Package</a>
                                                    </li>
                                                    <!-- <li class="site-nav__menu-sub-item">
            ...
            <!-- End Header -->
<!-- Hero Section -->
<section alt="building with windows" class="hero ptb-100" style="background-image:url(../assets/custom/images/50.png" alt="building with windows">
	<!-- Container -->
	<div class="container">
		<!-- Row -->
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						...
						<p>
							Our Digital package offers a simple but cost-effective way to incorporate your company for &pound;12.89 plus VAT through email with an attached PDF file.
						</p>
						...
						<p>
							If your primary consideration is speed and time efficiency the Digital Incorporation Package is made for you. Based on Companies House processes your company should be incorporated within 3-6 hours of submission.
						</p>
						...
						<p>
							New businesses are constrained by finances and must often operate on a tight budget. The Digital incorporation package would be most appropriate if you operate a tight budget.
						</p>
						...
						<p>
							The Digital Incorporation package takes away unnecessary, cumbersome and difficult processes of incorporating a company by doing all the hard work for you. If you require a Basic Single Class Structure company then the Digital Package is best for you&hellip;.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<h3>
							Are there any other hidden cost incurred under the Digital Package?
						</h3>

						<p>
							The Prime Formations &lsquo;Digital Incorporation package&rsquo; has no hidden costs. The cost of the Digital package is as stated. We charge &pound;12.89 plus VAT for the package which includes Companies House incorporation charge of &pound;12. There are no renewal charges and the charge is one-off.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
				...
				<section class="widget widget_categories">
					...
					<div class="service-list-pro">
						...
						<div class="others-option" style="text-align: center;">
							<a class="default-btn" href="../buy/digital-package/index.php">
								Order Now 
							</a>
						</div>
					</div>
