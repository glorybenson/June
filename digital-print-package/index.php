...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-digital-print-package/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                <div class="site-nav__menu-col-one">                                          
                                                    ...
                                                    <!-- <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Digital & Print Package </a>
                                                    </li> -->
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						...
						<p>
							The Prime Formations &lsquo;Digital and Print Package&rsquo; offers the best of both digital and print technology. Documents such as Certificate of Incorporation, Memorandum and Articles of Association, and Company Register of First Entries are sent digitally by email with PDF attachments. The same documents in print form and bound are also sent through the post at a minimal cost.
						</p>

						<p>
							The actual cost for this service is &pound;98.89 Plus VAT but the reduced price of &pound;59.99 Plus VAT is all you have to pay.
						</p>
					...
					<div class="faq">
						...
						<h3>
							Are there any other hidden cost incurred under the Digital and Print Package?
						</h3>

						<p>
							The Prime Formations &lsquo;Digital and Print Formation Package&rsquo; has no hidden costs. The cost of the Digital and Print package is as stated. We charge &pound;59.99 Plus VAT for the package which includes the Companies House incorporation charge of &pound;12. There are no renewal charges and the charge is one-off.
						</p>
				...
				<section class="widget widget_categories">
					...
					<div class="service-list-pro">
						...
						<div class="others-option" style="text-align: center;">
							<a class="default-btn" href="/buy/digital-print-package/">
								Order Now 
							</a>
						</div>
					</div>
