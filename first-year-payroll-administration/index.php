...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-first-year-payroll-administration/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--inactive site-nav__menu--additional-services">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">  Payroll Administration</a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
                        ...
                        <p>
							Our   Payroll Administration is a bespoke service and is only available by contacting us at 
						...
						<p>
							Prime Formations offers a fully managed payroll service for employers of newly formed companies or for companies taking on staff for the first time.
						</p>

						<p>
							As a result of the complexities of monthly or weekly payroll administration, new, everchanging and complicated legislation including a stiff regime of penalties, and HMRC RTI [Real Time Information] filing, most employers find it cost-effective to outsource the payroll function.
						</p>

						<p>
							Again, third party payments such as Student Loans, Arranged Payments and Pension Administration including Pension Auto Enrolment provides further reasons why most employers particularly newly incorporated companies, find it convenient, less stressful and time-saving to engage our payroll administration services.
						</p>
						...
						<p>
							Once you place an order for our 1st year Payroll Administration service we would engage the following on your behalf:
						</p>

						<ul>
							<li>
								Provide HMRC Starter forms for all your newly employed staff
							</li>
							<li>
								Determine staff who qualify to be automatically enrolled for pension under the Pension Auto Enrolment scheme
							</li>
							<li>
								Register you with The Pensions Regulator
							</li>
							<li>
								Register you with any Pension Provider of your choice
							</li>
							<li>
								Monthly Pension Administration
							</li>
							<li>
								Obtain the monthly payroll schedule with detailed information on how many hours were worked by staff, the hourly rate or annual salary and any overtime, deductions and additions to the payroll
							</li>
							<li>
								Obtain a leavers information sheet where applicable
							</li>
							<li>
								Monthly PAYE, National Insurance, Statutory Maternity Pay [SMP], Statutory Paternity Pay and Statutory Sick Pay [SSP] Administration
							</li>
							<li>
								Validate and verify all data received
							</li>
							<li>
								Input the payroll data into our payroll software
							</li>
							<li>
								Review the output and forward it to you to check, confirm and authorise
							</li>
							<li>
								Production of electronic payslips or e-payslips
							</li>
							<li>
								Full Payment Submission [FPS] or Employer Payment Summary [EPS] to HMRC
							</li>
							<li>
								Production of online Real Time Information [RTI] schedule and submissions
							</li>
							<li>
								P45 for leavers
							</li>
							<li>
								Yearend processes and procedures and the production of P60s and P35s
							</li>
						</ul>
						...
						<p>
							Our Tax and Accounting Division-Prime Formations Partnership (a Firm of Qualified Accountants) would deliver 1st Year Payroll Administration Service as follows:
						</p>

						<h4>One-Off Set-up Fee with Pension Requirements &pound;375 plus VAT</h4>

						<p>
							The one off set up fee includes the following:
						</p>
						...
						<ul>
							...
							<li>
								Payroll Setup on our software systems
							</li>
							<li>
								Registration with The Pensions Regulator
							</li>
							<li>
								Registration with any Pension Provider of your choice
							</li>
						</ul>

						<h4>One-Off Set-up Fee without Pension Requirements &pound;150 plus VAT</h4>
						...
						<h4>Payroll Service &pound;55.00 Plus VAT per month [Up to 5 Employees per month]</h4>

						<p>
							Our Payroll Service is charged at &pound;55.00 per month for an employer with up to 5 members of payroll staff. Additional employed staff is charged at &pound;7.50 plus VAT per staff per month.
						</p>

						<p>
							To ensure that we do not run foul of HMRC deadlines for RTI submissions, your payroll schedule must get to us by the 18th of every month. We aim to turn around the payroll and make submissions 5 working days from the date we receive your payroll schedule.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<p>
							Our 1st Year payroll administration service is available to anyone. It is not restricted to companies formed by Prime Formations.
						</p>

						<h3>
							Subsequent Years Payroll Administration Service
						</h3>

						<p>
							If your company requires subsequent years [not 1st year] payroll administration we would refer you to Prime Formations Partnership, an associate company and a firm of qualified accountants who would assist you further. Anyone can apply for this service as it is not restricted to companies formed by Prime Formations.
						</p>
