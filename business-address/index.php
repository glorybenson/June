                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                <div class="site-nav__menu-col-one">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php"> Business Address </a>
                                                    </li>
                                                </div>
                                            </ul>
                                        </div>
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<p>
							The &lsquo;Business Address service&rsquo; provided at our offices in the heart of Liverpool is for limited companies and LLPs who wish to receive general correspondence at a corporate address. The image of your company is enhanced if your address for business purposes is within a corporate and professional setting and not at a residential dwelling.
						</p>

						<p>
							General-purpose mail received on behalf of your company is posted out to you within 2 working days at the cost of Royal Mail postage plus a 16% handling fee.
						</p>

						<p>
							The service address we provide ensures that for &pound;95.89 plus VAT you can access our address at:<br>
							Newspring House<br>
						...
						<p>
							It is important to note that the purchase of the Business mail service does not entitle you to our Registered Office Address service nor our Service Address. These have to be purchased separately.
						</p>
						<!--<p>
							There is no further charge to scan and email official correspondence to you wherever you maybe in the world within 2 working days.
						</p> -->
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<h3>
							Business Address Service Explained
						</h3>

						<p>
							The Business Address service is not a legal requirement as you may well receive general business correspondence from suppliers, customers, lenders, banks, and other parties at your residential home. However, to create a corporate and professional image you may choose to receive your general-purpose correspondence from a business address.
						</p>
						<!--<p>
							The address would remain on the Companies House public register until changed by the Directors or removed once the company is dissolved. Official correspondence from Government agencies such as Companies House, HMRC, Government Gateway, Department of Work and Pensions [DWP] amongst others would be sent to your service address.
						</p>-->
						...
						<h3>
							Are there any other hidden costs incurred under the Business Address?
						</h3>

						<p>
							Prime Formations offers &lsquo;The Business Service Address&rsquo; with no hidden costs. The cost of the service is as stated. We charge &pound;99.89 plus VAT for the service per Company per year. Additional costs would be invoiced monthly based on the cost of Royal Mail postage plus 16% handling fee per document sent.
						</p>

						<p>
							You must be aware that our Business Service Address is strictly for that purpose only. Should you require further address services such as Registered Office Address or Service Address this must be paid for separately.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
