...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-company-name-change/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                <div class="site-nav__menu-col-one">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Company Name Change </a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<h4>Company Name Change</h4>


						<p>
							The Directors or members of a trading company, or an LLP may decide to change the name of their limited company by shares, limited company by guarantee or LLP for a variety of reasons. If the name is too similar to an existing company they may be advised by the registrar to change the name, Also, the nature of their business may change warranting a name change to reflect the essence of the new business.
						</p>

						<p>
							Whatever the reason for a name change, Prime Formations can help with the process. We can prepare and file Form NM01 on your behalf and provide all necessary documents such as minutes of meeting detailing the shareholders, directors or members decision to change the company name, a written special resolution, minutes of meeting and the certificate of name change.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<p>
							Our fees cover the Companies House fee currently at &pound;10.
						</p>

						<p>
							The preparation and filing of necessary documents for the name change such as minutes of meeting, a written special resolution, and the certificate of company name change.
						</p>
						...
						<p>
							Once the order is selected and payment is made, we would send you an email detailing all our requirements. You would have to work on our detailed schedule of requests and forward them to us once fulfilled. Once the completed schedule is received with the electronically signed form, we would expect the company name change to be effected within 3 working days subject to the Companies House work schedule.
						</p>

						<p>
							In special cases where you have chosen sensitive names as part of your new company name, this would need to be approved by the relevant authority such as Standards and Accreditation Team [Department for Business, Energy &amp; Industrial Strategy], Sensitive Business Names Team [Financial Conduct Authority] and many other applicable regulatory bodies who would consider your application and issue a letter or email of non-objection.
						</p>
						...
						<h3>
							Are there any other hidden costs incurred under the Company Name Change Service?
						</h3>

						<p>
							Our Company Name Change Service has no hidden costs. The cost of the service is as stated. We charge &pound;45.00 plus VAT for the service. This service does not include the application to relevant regulatory bodies for their approval, and non-objection to the use of a particular name. We charge an additional fee of &pound;29.89 plus VAT per application.
						</p>
