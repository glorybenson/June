                                        ...
                                        <div class="site-nav__menu site-nav__menu--inactive site-nav__menu--additional-services">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    <h3>Tax</h3>
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Self Assessment Registration</a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<h4>Self Assessment Registration</h4>

						<p>
							Our Self Assessment Registration is a bespoke service and is only available by contacting us at 
						...
						<p>
							You must register for self assessment if you have to send a tax return and you did not send in one the year before. You would need to register for Self Assessment if you are:
						</p>

						<ul>
							<li>
								Self Employed for example Artisans, Tradesmen, Business Owners or Professionals
							</li>
							<li>
								Not Self Employed for example Directors of a company, Property Investors, if you sold a property
							</li>
							<li>
								You are registering as a Partner or a Partnership
							</li>
						</ul>

						<p>
							If you are self employed and running a business you would need to register for Self Assessment and Class 2 National Insurance within 28 days of starting your business however from 6th April 2017 if your trading income is less than &pound;1,000 you do not need to register. [Trading Allowance]
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<h3>
							Ways to Register for Self Assessment
						</h3>

						<p>
							You can choose either of these three ways to register for Self Employment:
						</p>
						...
						<p>
							Our Tax and Accounting Division-Prime Formation Partnership (a Firm of Qualified Accountants) would register you online for Self Assessment purposes. Once you place an order, we would forward by email a Self Assessment questionnaire which captures every information required in completing the Self Assessment application. Once completed HMRC would send you a letter with your UTR number.
						</p>

						<p>
							The cost of this service is &pound;89.89 plus VAT. We have our dedicated line for any questions on the Self Assessment application process.
						</p>

						<p>
							We would also provide step by step instructions on how to create your own Government Gateway Account should you require the same.
						</p>
						...
						<p>
							To register online by yourself you would need to log on to the HMRC website and supply an email address to begin the process. The process would generate a Government Gateway User ID unique to you and would become the login details by which you can access your account with HMRC.
						</p>

						<p>
							Once the Government Gateway User ID is generated you would be required to login with the newly formed login details and complete the process which would require details such as passport, driving license, payslips or P60 and proof of address amongst others.
						</p>

						<p>
							At the end of the process, you will receive a letter within 10 working days [21 days if overseas] with your Unique Tax Reference [UTR]. You would always need your UTR to file a tax return. You will also receive a letter with an activation code for your account.
						</p>

						<p>
							Once your account is activated you can file your tax return at any time before the deadline.
						</p>

						<p>
							The Paper tax return filing deadline is 31st October every year and the Online tax return filing deadline is 31st January of the following year.
						</p>

						<h3>
							Registering with Form CWF1
						</h3>

						<p>
							You may decide to complete Form CWF1 online, print and post it to HMRC and you should be registered for Self Assessment within 20-30 days. You would be required to provide personal details such as National Insurance number, Date of Birth, Full Names, Current home address amongst others. You would also be required to supply information about your business such as when your business started, your business name and the type of self-employment amongst others.
						</p>
						...
						<p>
							Formation Agents such as ourselves are required by the law-The Money Laundering and Terrorist Financing (Amendment) Regulations 2019 and previous Money Laundering Regulations to check proof of ID and Address. We carry out digital ID checks on our customers and most do not have to do anything else except complete the online formation forms. A very minute percentage of our customers may need to supply further information if they fail the digital ID tests or are not eligible for one.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
