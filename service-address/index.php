                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                <div class="site-nav__menu-col-one">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Service Address  </a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<p>
							Service Address is a Companies House requirement in the process of incorporating a company. A service address is the correspondence address of Company Officials to which all official documents from government agencies such as Companies House, HMRC, Government Gateway, The Pensions Regulator, Office of National Statistics amongst others is sent. Such Company Officials include Directors, Shareholders, Secretaries, and Persons with Significant Control [PSC]
						</p>

						<p>
							Most Company Officials tend to choose their residential address for the purpose of receiving official mail. However, a few who prefer to protect their privacy, and the sanctity and peace of their residential addresses would opt for the service address we provide.
						</p>

						<p>
							The service address we provide ensures that for &pound;29.89 plus VAT you can access our address at:<br>
							<br>
							Newspring House<br>
						...
						<p>
							It is important to note that the fees quoted is for each director or company official who wishes to use this service. For instance, if you have 6 directors all of them would have to pay &pound;29.89 plus VAT each.
						</p>
					...
					<div class="faq">
						...
						<p>
							A major Companies House requirement in the incorporation process is the Service Address which is the statutory address for the directors and other officials of the newly incorporated company. The service address must be a physical address as Companies House would not accept a Post Office Box Number.
						</p>
						...
						<h3>
							Are there any other hidden costs incurred under the Service Address?
						</h3>

						<p>
							The Service Address as offered by ourselves has no hidden costs. The cost of the service is as stated. We charge &pound;29.89 plus VAT for the service per Company Official per year. You must however be aware that our Service Registered Office service is strictly for that purpose only. Should you require further address services such as Registered Office Address or Business Mail Address this must be paid.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
