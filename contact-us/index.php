...
<html>
    ...
    <body id="ef-contact-us/">
        ...
        <div id="wrapper">
            ...
            <!-- End Header -->
            <!-- Hero Section -->
            <section class="hero ptb-100" style="background-image:url(../assets/custom/images/56.png);">
                <!-- Container -->
                <div class="container">
                    <!-- Row -->
                        ...
                        <div class="col-lg-6 col-md-12">
                            ...
                            <div class="checkout-area ptb-10">
                                ...
                                <div class="user-actions">
                                    <p>
                                        Our Customer Services Team are available within our office hours of 9 am-5 pm Monday to Friday to attend to any enquiry you may have.
                                    </p>

                                    <p>
                                        We check messages sent through email and through our Contact box below throughout the day and night and would respond to these requests within 6-8 hours of receiving your requests.
                                    </p>

                                    <h4>CUSTOMER SERVICES LINE: 0333 533 0264</h4>

                                    <h4>
                                        <a href="mailto: customerservices@primeformations.co.uk">
                                            EMAIL: customerservices@primeformations.co.uk
                                        </a>
                                        &lt;
                                    </h4>
                                </div>
