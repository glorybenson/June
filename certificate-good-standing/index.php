...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-certificate-good-standing/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--packages site-nav__menu--inactive">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Certificate of Good Standing </a>
                                                    </li>
                                                    <li class="site-nav__menu-sub-item">
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<h4>Certificate Of Good Standing Service</h4>

						<p>
							Our Certificate Of Good Standing Service is a bespoke service and is only available by contacting us at 
						...
						<p>
							A limited liability company may be required to produce a certificate of good standing for several reasons such as:
						</p>
						...
						<ul>
							...
							<li>
								Opening a foreign branch of a UK Company
							</li>
						</ul>

						<p>
							A Certificate of Good Standing as issued by Companies House would state that &lsquo;a company has been in continuous, unbroken existence since its incorporation and that no action is currently being taken to strike the company off the register&rsquo;
						</p>

						<p>
							Companies House would only issue a good standing statement if your company is up-to-date with its filing obligations.
						</p>

						<p>
							Prime formations would charge as a separate activity our normal fee per service if for instance, you are late with the filing of the annual Confirmation Statement, annual financial accounts or the update of statutory registers before a Certificate of Good Standing can be issued.
						</p>

						<p>
							Information concerning the Date of Incorporation, Directors, Secretaries, Registered office address, and Company objects are verified by Companies House accordingly.
						</p>

						<p>
							For our stated fee of &pound;85.00 plus VAT, we would obtain the Certificate of Good Standing and post same by Royal Mail Special Delivery or international tracked signed mail service at no extra charge to any country in the world. Where you require courier delivery services such as DHL we are able to arrange for this at an additional fee.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
					...
					<div class="faq">
						...
						<p>
							Our Certificate of Good Standing Service has no hidden costs. The cost of the service is as stated. We charge &pound;85.00 plus VAT. The fee stated however does not include our normal fee for additional services that may be required such as filing a Confirmation Statement to obtain the Certificate of Good Standing. Anyone may access this service as it is not restricted to companies incorporated by us.
						</p>
					</div>
					<!-- End FAQs -->
				</div>
