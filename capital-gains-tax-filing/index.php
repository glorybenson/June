...
<script>
  ...
  <title>Prime Formations - We are expert in Company Formation , Company Registration & Company setup.</title>
    ...
    <!-- Body -->
    <body id="ef-capital-gains-tax-filing/">
                                        ...
                                        <div class="site-nav__menu site-nav__menu--inactive site-nav__menu--additional-services">
                                            <ul class="site-nav__menu-links">
                                                ...
                                                <div class="site-nav__menu-col-two">
                                                    ...
                                                    <li class="site-nav__menu-sub-item">
                                                        <a href="index.php">Capital Gains Tax Filing</a>
                                                    </li>
                                                </div>
			...
			<div class="col-lg-7 col-md-12">
				...
				<div class="checkout-area ptb-10">
					...
					<div class="user-actions">
						<h2>
							Capital Gains Tax Service [CGT]- &pound;550 Plus VAT
						</h2>
                        <p>
							Our Capital Gains Tax Service is a bespoke service and is only available by contacting us at 
						...
						<p>
							Capital Gains Tax is a tax on chargeable persons who have made a profit on assets disposed of through sales, gifts, swaps or other means. The assets disposed of may include Buy-to-let property, residential or commercial property, shares and stocks and other chattels.
						</p>

						<p>
							There is a yearly provision for a Capital Gains Allowance which reduces the liability to Capital Gains Tax. The tax-free allowance [Annual Exemption Amount] for the year 2021/2022 is &pound;12,300.
						</p>

						<p>
							The Taxation of Chargeable Gains Act 1992 identifies the following persons as liable to tax on their capital gains:
						</p>
						...
						<ul>
							...
							<li>
								Companies who are assessable to tax on their chargeable gains through Corporation tax
							</li>
						</ul>
						...
						<p>
							At Prime Formations, we can help with determining your Capital Gains Tax liability by observing the following steps:
						</p>

						<p>
							To report any Capital Gains as stated by HMRC you will need:
						</p>
						...
						<ul>
							...
							<li>
								Any other relevant details, such as the costs of disposing of the asset and any tax reliefs you&rsquo;re entitled to
							</li>
							<li>
								Where you sold the residential property on or after 6 April 2020 you would need to report and pay any tax on UK residential property using a &lsquo;Capital Gains Tax on UK Property Account&rsquo; within 30 days of selling it.
							</li>
							<li>
								For non-residents, you must use the above service according to HMRC for disposals from 6 April 2020 of the following properties:
								<ul>
									<li>
						...
						<p>
							Once you place an order, we would require the following information to be in a position to calculate your Capital Gains:
						</p>
						...
						<ul>
							...
							<li>
								Date of Exchange of contracts at the point of selling or disposing of the Property
							</li>
							<li>
								Completion Date
							</li>
							<li>
								Value of the Property at Acquisition or Purchase
							</li>
							<li>
								Value of the Property at disposal
							</li>
							<li>
								Costs of buying, selling or making improvements to the property
							</li>
							<li>
								Details of relevant tax reliefs, allowances or exemptions
							</li>
							<li>
								For non-residents- the type of property disposed of
							</li>
						</ul>
						...
						<p>
							Our Tax and Accounting Division-Prime Formations Partnership (a Firm of Qualified Accountants) Would deliver Capital Gains Tax Computations and Submissions particularly within 30 days of sale.
						</p>

						<h2>
							Capital Gains Tax Computation [Property value up to &pound;500,000] &pound;550 plus VAT
						</h2>
						...
						<ul>
							<li>
								Computation of CGT Liability
							</li>
							<li>
								Application of available tax reliefs and claims where relevant
							</li>
							<li>
								Creation of a &lsquo;Capital Gains Tax on UK Property Account&rsquo;
							</li>
							<li>
								Completion and submission of the return within 30 days of the sales or disposal of your property.
							</li>
							<li>
								To achieve the very tight deadline all paperwork as enumerated above must be received by Day 10 after the sale giving us a clear 20 days time frame to complete and submit the return and advise you of payments you need to make to HMRC.
							</li>
						</ul>

						<p>
							Please be aware that the completion of a self assessment tax return is charged separately.
						</p>
					</div>
					<!-- User Actions --><!-- FAQs -->
